...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-cfg', type=str, default='cfg/volen.data', help='volen.data file path')
    parser.add_argument('--multi-scale', action='store_true', help='random image sizes per batch 320 - 608')
    parser.add_argument('--img-size', type=int, default=1920 * 1080, help='pixels')
